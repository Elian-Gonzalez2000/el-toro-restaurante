...
export const cartConstants = {
   CART_PAY_REQUEST: "CART_PAY_REQUEST",
   CART_PAY_SUCCESS: "CART_PAY_SUCCESS",
   CART_PAY_FAILURE: "CART_PAY_FAILURE",
   ADD_TO_CART_REQUEST: "ADD_TO_CART_REQUEST",
   ADD_TO_CART_SUCCESS: "ADD_TO_CART_SUCCESS",
   ADD_TO_CART_FAILURE: "ADD_TO_CART_FAILURE",
   DELETE_TO_CART_REQUEST: "DELETE_TO_CART_REQUEST",
   DELETE_TO_CART_SUCCESS: "DELETE_TO_CART_SUCCESS",
   DELETE_TO_CART_FAILURE: "DELETE_TO_CART_FAILURE",
   GET_TOTAL_PRICE_REQUEST: "GET_TOTAL_PRICE_REQUEST",
   GET_TOTAL_PRICE_SUCCESS: "GET_TOTAL_PRICE_SUCCESS",
   GET_TOTAL_PRICE_FAILURE: "GET_TOTAL_PRICE_FAILURE",
};
